...
bool bboxes__msg__first_pick_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bboxes.msg._first_pick_box.FirstPickBox", full_classname_dest, 39) == 0);
  }
  bboxes__msg__FirstPickBox * ros_message = _ros_message;
  {  // color_image
...
{
  /* NOTE(esteve): Call constructor of FirstPickBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bboxes.msg._first_pick_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FirstPickBox");
