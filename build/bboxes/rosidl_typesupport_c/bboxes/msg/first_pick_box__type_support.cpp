...
#include "bboxes/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _FirstPickBox_type_support_symbol_names_t _FirstPickBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bboxes, msg, FirstPickBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bboxes, msg, FirstPickBox)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_bboxes
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bboxes, msg, FirstPickBox)() {
  return &::bboxes::msg::rosidl_typesupport_c::FirstPickBox_message_type_support_handle;
}
