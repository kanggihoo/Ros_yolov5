...
#ifndef BBOXES__SRV__DETAIL__IMAGE_FIRST_PICK_BOX__FUNCTIONS_H_
#define BBOXES__SRV__DETAIL__IMAGE_FIRST_PICK_BOX__FUNCTIONS_H_
...
#include "bboxes/msg/rosidl_generator_c__visibility_control.h"

#include "bboxes/srv/detail/image_first_pick_box__struct.h"

/// Initialize srv/ImageFirstPickBox message.
/**
...
/// Create srv/ImageFirstPickBox message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bboxes__srv__ImageFirstPickBox_Request__init().
...
/// Destroy srv/ImageFirstPickBox message.
/**
 * It calls
 * bboxes__srv__ImageFirstPickBox_Request__fini()
...
/// Check for srv/ImageFirstPickBox message equality.
/**
...
/// Copy a srv/ImageFirstPickBox message.
/**
...
/// Initialize array of srv/ImageFirstPickBox messages.
/**
...
/// Finalize array of srv/ImageFirstPickBox messages.
/**
 * It calls
 * bboxes__srv__ImageFirstPickBox_Request__fini()
...
/// Create array of srv/ImageFirstPickBox messages.
/**
 * It allocates the memory for the array and calls
 * bboxes__srv__ImageFirstPickBox_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ImageFirstPickBox messages.
/**
 * It calls
 * bboxes__srv__ImageFirstPickBox_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ImageFirstPickBox message array equality.
/**
...
/// Copy an array of srv/ImageFirstPickBox messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bboxes__srv__ImageFirstPickBox_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bboxes
...
/**
 * It calls
 * bboxes__srv__ImageFirstPickBox_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bboxes
...
/**
 * It allocates the memory for the array and calls
 * bboxes__srv__ImageFirstPickBox_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bboxes
...
/**
 * It calls
 * bboxes__srv__ImageFirstPickBox_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BBOXES__SRV__DETAIL__IMAGE_FIRST_PICK_BOX__FUNCTIONS_H_
